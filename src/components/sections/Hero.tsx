...
const Hero = () => {
  ...
  return (
    <section className='relative min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat'
      style={{ backgroundImage: `linear-gradient(rgba(30,64,175,0.7), rgba(30,64,175,0.5)), url('/plane2.jpg')` }}
    >
      ...
      >
        <div className='max-w-4xl mx-auto'>
          ...
          >
            From local deliveries to global shipping, we move your business forward with speed, security, and precision.
          </motion.p>
