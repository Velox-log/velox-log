...
const ServicesPage: React.FC = () => {
  ...
  const services: Service[] = [
    {
      ...
      description: 'Reliable and cost-effective ground transportation for domestic deliveries with real-time tracking and flexible scheduling options.',
    ...
    },
    {
      id: 'air-freight',
      title: 'Air Freight',
      description: 'Express air cargo services for time-sensitive shipments with global reach and priority handling for urgent deliveries.',
    ...
    },
    {
      id: 'ocean-freight',
      title: 'Ocean Freight',
      description: 'Cost-effective sea cargo solutions for large volume international shipments with full container and LCL options.',
    ...
    },
    {
      ...
      description: 'Secure storage and distribution solutions with advanced inventory management, pick & pack services, and fulfillment options.',
    ...
    },
    {
      ...
      description: 'Ultra-fast delivery services for urgent packages and documents with same-day pickup and guaranteed delivery times.',
    ...
    },
    {
      ...
      description: 'End-to-end international supply chain management with trade compliance, risk management, and consulting services.',
  ...
  const faqs: FAQ[] = [
    {
      ...
      answer: 'You can track your shipment using our online tracking system with your tracking number. We also provide real-time updates via email and SMS notifications.'
    },
    {
      question: 'What insurance options are available?',
      answer: 'We offer comprehensive insurance coverage up to $100,000 for most shipments. Higher coverage amounts are available for valuable items with additional premium.'
    },
    {
      question: 'Do you handle international customs clearance?',
      answer: 'Yes, our experienced customs team handles all documentation and clearance procedures for international shipments, ensuring smooth border crossings.'
    },
    {
      question: 'What are your pickup and delivery hours?',
      answer: 'Standard pickup and delivery hours are 9 AM to 6 PM, Monday through Friday. Extended hours and weekend service are available for express services.'
    },
    {
      question: 'How do I get a shipping quote?',
      answer: 'You can get an instant quote through our website calculator, call our customer service team, or request a custom quote for specialized requirements.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-no-repeat" style={{backgroundImage:`linear-gradient(rgba(30,64,175,0.7), rgba(30,64,175,0.5)), url('/ship3.jpg')`}}>
      {/* Hero Section */}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">
                  ...
                  <div className="text-sm font-semibold text-gray-900">{currentService.deliveryTime}</div>
                  <div className="text-xs text-gray-500">Delivery Time</div>
                </div>
                <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">
                  <MapPin className="w-6 h-6 text-secondary mx-auto mb-2" />
                  <div className="text-sm font-semibold text-gray-900">{currentService.coverage}</div>
                  <div className="text-xs text-gray-500">Coverage</div>
                </div>
                <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">
                  <Star className="w-6 h-6 text-secondary mx-auto mb-2" />
                  <div className="text-sm font-semibold text-gray-900">{currentService.pricing}</div>
